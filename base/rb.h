 ...
 *
 */
static inline bool _RBTree_Is_first(
  const RBTree_Control *the_rbtree,
  const RBTree_Node *the_node,
  RBTree_Direction dir
)
 ...
 */
static inline RBTree_Control *_RBTree_Find_control(
  const RBTree_Node *the_node
)
{
...
{
  return rbtree_next( node, RBT_LEFT );
}
...
{
  return rbtree_next( node, RBT_RIGHT );
}
 ...
 */
static inline RBTree_Direction _RBTree_Opposite_direction(
 ...
 */
static inline RBTree_Direction _RBTree_Direction(
  const RBTree_Node *the_node,
 ...
 */
static inline bool _RBTree_Is_red(
    const RBTree_Node *the_node
    )
{
 ...
 */
static inline RBTree_Node *_RBTree_Sibling(
  const RBTree_Node *the_node,
  const RBTree_Node *parent
)
{
...
static inline bool _RBTree_Is_equal(
...
static inline bool _RBTree_Is_greater(
  RBTree_Compare_result compare_result
)
{
  return compare_result > 0;
...
static inline bool _RBTree_Is_lesser(
  RBTree_Compare_result compare_result
)
{
  return compare_result < 0;
...
static inline RBTree_Node *_RBTree_Minimum( 
 ...
 */
static inline void _RBTree_Rotate(
  RBTree_Node      *the_node,
  RBTree_Direction  dir
)
{
